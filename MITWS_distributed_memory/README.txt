...
This is the Distributed Memory parallel strategy for the MITWS algorithm. 
Functions like cross-validation, XML input, Grid Search, UCAIM, and etc still need to be added to this part.